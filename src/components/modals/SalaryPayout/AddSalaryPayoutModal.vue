<template>
    <div class="modal fade" id="addreceipt" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="modal-title m-0">Add Salary Payout</div>
...
export default {
    ...
    mounted() {
        this.modal = new Modal(document.getElementById('addreceipt'));
    },
    methods: {
        showModal() {
            this.modal.show()
